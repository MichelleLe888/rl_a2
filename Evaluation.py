...
def average_over_repetitions(n_repetitions,n_episodes,smoothing_widnow,with_mb=True,with_tn=True):
    ...
    for rep in range(n_repetitions):
        ...
        rewards = deep_q_learning(n_episodes=n_episodes,max_episode_lenght=200,memory_buffer_size=2000,learning_rate=0.1,gamma=1.0,epsilon=0.01,batch_size=32,with_mb=with_mb,with_tn=with_tn)
...
def experiment():
    ...
    learning_curve = average_over_repetitions(10, n_episodes,31,with_mb=True,with_tn=True)
...
def experiment_lr():
    ...
    for lr in learning_rates:
        learning_curve = average_over_repetitions(50, n_episodes)
